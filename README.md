##Seed Code - Boilerplate for Assignment 3 - Data Munging Assignment (PLEASE CHANGE THIS README POST CLOINING - SAVE THE INSTRUCTIONS SEPERATELY)

###Problem Statement
Download the CSV file from the link provided and store that CSV file in data folder provided in the repository. 
Read the downloaded CSV file line by line and print the output in console.

###Expected solution
Display the CSV file contents in console.

### Following are the broad tasks:

1. Import fs module
2. Read file contents and process the data
3. Split the data into lines
4. Print the file contents line by line on console
...
1. Clone the base boilerplate in your local
	...
	`git clone https://gitlab-wd.stackroute.in/programmingfundamentals/qa2qe-wk2-assignment3.git`
